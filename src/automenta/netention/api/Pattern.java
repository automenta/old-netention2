...
import automenta.netention.api.value.geo.GeoPointVar;
import automenta.netention.api.value.integer.IntegerVar;
import automenta.netention.api.value.node.NodeVar;
import automenta.netention.api.value.real.RealVar;
import automenta.netention.api.value.real.TimePointVar;
